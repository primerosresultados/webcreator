...
<head>
    ...
    <meta name="description" content="Constructora y estudio de arquitectura premium. Del concepto a la realización. Cotiza tu proyecto hoy.">
    <meta name="robots" content="index, follow">
    <meta name="theme-color" content="#1a1a1a">
    
    <!-- Open Graph -->
    <meta property="og:title" content="MiSitio — Arquitectura & Construcción">
    <meta property="og:description" content="Redefinimos cómo se construye el mundo. Cotiza tu proyecto hoy.">
    <meta property="og:type" content="website">
    
    <title>MiSitio — Arquitectura & Construcción Premium</title>
    
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='18' fill='%231a1d2e'/><text x='50' y='68' text-anchor='middle' fill='%23c9a96e' font-size='52' font-weight='bold'>M</text></svg>">
    ...
    <header class="site-header" id="header">
        <nav class="nav container">
            ...
            <div class="nav-links" id="nav-links">
                ...
                <a href="tel:+56912345678" class="nav-phone"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;display:inline;vertical-align:middle;margin-right:4px;"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>+56 9 1234 5678</a>
        ...
        <div class="container">
            <div class="hero-grid">
                ...
                <div class="hero-content" data-animate="fadeInUp">
                    ...
                    <p class="hero-desc">
                        Arquitectura y construcción de excelencia. Transformamos ideas en espacios que inspiran, con calidad, innovación y compromiso.
                    </p>
    ...
    <section class="section welcome-section" id="nosotros">
        <div class="container">
            <div class="welcome-content" data-animate="fadeInUp">
                <span class="welcome-badge">BIENVENIDOS A MISITIO</span>
                <h2>
                ...
                <div class="contact-form-wrap" data-animate="slideInRight">
                    ...
                    <form id="contact-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" class="form-input" placeholder="+56 9 1234 5678">
                        </div>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <p>Del concepto a la realización. Transformamos ideas en espacios que inspiran.</p>
                </div>
            ...
            <div class="footer-bottom">
                <span>&copy; 2026 MiSitio. Todos los derechos reservados.</span>
                <div class="footer-social">
                    ...
                    <a href="#" aria-label="LinkedIn"><svg viewBox="0 0 24 24" fill="currentColor" style="width:18px;height:18px;"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg></a>
                </div>
            </div>
        </div>
    </footer>
    <!-- WhatsApp Floating Button -->
    <a id="whatsapp-btn" class="whatsapp-float" href="#" target="_blank" rel="noopener" aria-label="Escríbenos por WhatsApp" style="display:none;">
