<?php
// No-cache para HTML dinámico (evita HTML stale en hosting/CDN/browser)
...
<body class="is-loading">
        ...
        <div class="container">
            <div class="contact-grid">
                <div class="contact-info" data-animate="slideInLeft">
                    ...
                    <?php
                    // Helpers para Instagram: aceptar URL completa, "@handle" o "handle"
                    ...
                    <div class="contact-detail">
                        ...
                        <div>
                            <strong>Email</strong>
                            <span><a href="mailto:<?=$h($S['email'])?>" style="color:inherit;text-decoration:none;"><?=$h($S['email'])?></a></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="contact-detail">
                        ...
                        <div>
                            ...
                            <span><a href="tel:<?=$h($phoneClean)?>" style="color:inherit;text-decoration:none;"><?=$h($S['phone'])?></a></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <?php if ($igHandle): ?>
                    <div class="contact-detail">
                        <div class="contact-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="width:20px;height:20px;"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg></div>
                        <div>
                            <strong>Instagram</strong>
                            <span><a href="<?=$h($igUrl)?>" target="_blank" rel="noopener" style="color:inherit;text-decoration:none;">@<?=$h($igHandle)?></a></span>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <a href="#servicios">Compromiso Total</a>
                </div>
                ...
                <div class="footer-col">
                    ...
                    <?php endif; ?>
                    <?php
                    // Reusar la lógica de arriba: $igHandle, $igUrl ya están seteados
                    // por el bloque de contact-detail. Si no, fallback acá.
                    if (empty($igHandle)) {
                        $rawIg = trim($S['instagram'] ?? '');
                        if ($rawIg) {
                            if (preg_match('#instagram\.com/([^/?#]+)#i', $rawIg, $mIg)) {
    ...
    <!-- WhatsApp Floating Button (link directo, sin JS intermedio) -->
    <?php if (!empty($S['whatsapp'])):
        $waNumber = preg_replace('/\D+/', '', $S['whatsapp']);
        $waMsg = rawurlencode('Hola, me gustaría obtener más información.');
    ?>
    <a class="whatsapp-float" href="https://wa.me/<?=$h($waNumber)?>?text=<?=$waMsg?>" target="_blank" rel="noopener" aria-label="Escríbenos por WhatsApp">
